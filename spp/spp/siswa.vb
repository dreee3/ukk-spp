...
Public Class siswa
    ...
    Private Sub PD_PrintPage(sender As Object, e As PrintPageEventArgs) Handles PD.PrintPage
        ...
        e.Graphics.DrawString("nisn", f10, Brushes.Black, 20, 150)
        e.Graphics.DrawString("jumlah bayar", f10, Brushes.Black, 200, 150)
        e.Graphics.DrawString("tanggal bayar", f10, Brushes.Black, 450, 150)
        dgv_laporan.AllowUserToAddRows = False

        Dim tinggi As Integer
        For baris As Integer = 0 To dgv_laporan.RowCount - 1
            tinggi += 20
            e.Graphics.DrawString(dgv_laporan.Rows(baris).Cells(0).Value.ToString, f10, Brushes.Black, 20, 160 + tinggi)
